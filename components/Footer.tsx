        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              ...
              <button
                type="submit"
                className="bg-blue-600 dark:bg-black dark:border-[2px] dark:border-white dark:hover:bg-gray-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
