      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div>
            ...
            <div className="mt-4 space-y-2 text-sm">
              <p>Tel: +256 770983239</p>
              <p>Tel: +256 707013121</p>
              <p>Email: clancyro1000@gmail.com</p>
            </div>
          ...
          <div>
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-3 py-2 bg-gray-700 dark:bg-gray-800 text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
              />
              <button
                type="submit"
                className="bg-blue-600 dark:bg-black dark:border-b-[1px] dark:border-l-[1px] dark:border-white dark:hover:bg-gray-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors duration-200"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-8 h-24">
          ...
          <div className={`transition-opacity duration-500 ${showQuote ? "opacity-100" : "opacity-0"}`}>
            <p className="text-center italic text-lg">"{quotes[quoteIndex].text}"</p>
            <p className="text-center text-sm mt-2">- {quotes[quoteIndex].author}</p>
          </div>
        </div>
