...
import { Eye, EyeOff, Lock, User, LogIn, Clock, UserPlus } from "lucide-react"
...
export function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-slate-100 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 flex items-center justify-center p-4">
      <Card className="w-full max-w-md bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border-purple-200 dark:border-purple-500/30 shadow-xl">
        ...
        <CardContent>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="pt-4 border-t border-purple-200 dark:border-purple-500/30">
              <Link href="/register">
                <Button
                  variant="outline"
                  className="w-full border-purple-300 dark:border-purple-500/50 text-purple-600 dark:text-purple-400 hover:bg-purple-50 dark:hover:bg-purple-500/10 transition-all duration-200 bg-transparent"
                >
            ...
            {/* Session Info */}
            <div className="bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-500/30 rounded-lg p-3">
              <div className="flex items-center gap-2 text-purple-600 dark:text-purple-400">
                <Clock className="h-4 w-4" />
                <p className="text-sm font-medium">Session Duration: 24 hours</p>
              </div>
              <p className="text-xs text-purple-500 dark:text-purple-400 mt-1">
                Stay logged in for a full day after signing in
              </p>
            </div>
          </div>
        </CardContent>
