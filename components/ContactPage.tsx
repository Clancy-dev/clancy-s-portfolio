  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 dark:from-gray-950 dark:via-slate-900 dark:to-black pt-20">
      <main className="container mx-auto px-4 py-8">
        ...
        >
          <Image src="/contact1.jpg" alt="Contact Hero" layout="fill" objectFit="cover" />
          <div className="absolute inset-0  bg-[rgba(0,0,0,0.5)] dark:bg-[rgba(0,0,0,0.7)] flex items-center justify-center">
