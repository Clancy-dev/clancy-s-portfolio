...
export default function ProjectsPage() {
  ...
  return (
    <>
    <Head>
        <title>Projects | Worked On By Clancy Ssekisambu</title>
        <meta name="description" content="Explore a showcase of web development projects built by Clancy Ssekisambu – from business websites to powerful web apps using React.js, Next.js, and Tailwind CSS." />
