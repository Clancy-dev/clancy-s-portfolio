    ...
    <header className="fixed top-0 left-0 right-0 bg-white dark:bg-gray-800 shadow-md z-20">
      ...
      {isMenuOpen && (
        <div className="fixed inset-0 z-10">
          ...
          <div className="absolute top-16 left-0 bottom-0 w-3/4 bg-white dark:bg-gray-800 shadow-lg">
            <div className="flex flex-col space-y-4 p-6">
              ...
              <button
                ...
                className="p-2 rounded-md bg-gray-200 dark:bg-gray-700 text-left"
              >
