    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-100 to-green- mt-[72px]">
      <main className="container mx-auto px-4 py-8">
        <section className="relative h-64 mb-12">
          <Image src="/contact-hero.jpg" alt="Contact Hero" layout="fill" objectFit="cover" className="rounded-lg" />
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-semibold mb-4 text-blue-600">Find Me</h2>
