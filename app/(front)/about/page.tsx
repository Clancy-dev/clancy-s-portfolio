...
export default function AboutPage() {
  return (
    <>
    <Head>
        <title>About Clancy Ssekisambu | Full Stack Developer in Uganda</title>
        <meta name="description" content="Discover the story of Clancy Ssekisambu, a passionate full stack web developer from Uganda, building modern websites and powerful web apps using React.js, Next.js and Tailwind CSS." />
