...
export function ProjectCard({
  ...
  return (
    <div className="group h-full flex flex-col gap-4 rounded-xl border border-border bg-card p-6 transition-all hover:shadow-lg hover:border-primary/30">
      ...
      {/* Company Name */}
      <p className="text-sm font-semibold text-foreground">{project.companyName}</p>
      ...
      {/* Features Section with Read More - Fixed Height */}
      <div className="space-y-2">
        <h4 className="text-sm font-semibold text-foreground">Features</h4>
        <div className="overflow-hidden transition-all duration-300" style={{ maxHeight: showFullFeatures ? '500px' : '120px' }}>
      ...
      {/* Problems Section with Read More - Fixed Height */}
      <div className="space-y-2">
        <h4 className="text-sm font-semibold text-foreground">Problems Solved</h4>
        <div className="overflow-hidden transition-all duration-300" style={{ maxHeight: showFullProblems ? '500px' : '80px' }}>
          <ul className="space-y-1">
